#!/usr/bin/env python3
"""
WMI Persistence Test Suite (Fixed)
===================================
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_all_trigger_types(self):
        ...
        subs = {
            'idle': wmi.create_idle_persistence(payload),
        ...
        for trigger_type, subscription in subs.items():
            self.assertEqual(subscription["trigger_type"], trigger_type)
            self.assertIn("filter_name", subscription)
