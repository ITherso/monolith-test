...
@tools_bp.route('/web-vuln-scanner')
...
@tools_bp.route('/api/web-vuln-scanner/categories')
...
@tools_bp.route('/api/web-vuln-scanner/chains')
...
@tools_bp.route('/api/web-vuln-scanner/scan', methods=['POST'])
def vuln_scanner_scan():
    ...
    target_url = (data.get('target_url') or data.get('target') or data.get('url') or '').strip()
...
@tools_bp.route('/api/web-vuln-scanner/result/<scan_id>')
...
@tools_bp.route('/api/web-vuln-scanner/stats')
